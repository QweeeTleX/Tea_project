...
Проект находится на этапе MVP: каталог, карточка товара, корзина, базовая авторизация и RBAC уже работают. Следующий шаг - вынести пользователей и товары в БД и улучшить функционал админ-панели.
